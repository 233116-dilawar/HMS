                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <ul class="navbar-nav ml-auto" style="margin-right: 70px;">
                                    ...
                                    <li class="nav-item active">
                                        <a class="nav-link" href="AdminHome.jsp">Home <span
                                    ...
                                    <div class="wrap-table100">
                                        <div class="table100 ver3 m-b-110">
                                            ...
                                            <% try { con=DatabaseConnection.initializeDatabase(); Statement
                                                st=(Statement) con.createStatement(); String sql="" ; String
                                                query=request.getParameter("search"); if (query !=null) {
                                                sql="select * from doctor where fname like '%" + query
                                                + "%' or lname like '%" + query + "%' " ; } else {
                                                sql="select * from doctor" ; } ResultSet rs=st.executeQuery(sql); while
                                                (rs.next()) { %>
