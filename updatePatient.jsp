                ...
                <%@page import="java.sql.Connection" %>
                    <%@page contentType="text/html" pageEncoding="UTF-8" %>
                        ...
                        <body>
                            ...
                            <% String mob=request.getParameter("mob"); Connection
                                con=DatabaseConnection.initializeDatabase(); String
                                s="SELECT * FROM patient WHERE mobile = '" +mob+"' ";
        ...
        <div class=" container-contact100">
                                ...
                                <div class="wrap-contact100">
                                    ...
                                    <form class="contact100-form validate-form"
                                        action="<%=request.getContextPath()%>/PatientServlet?action=update"
                                        method="post">
                                        ...
                                        <div class="wrap-input100 validate-input" data-validate="Phone is required">
                                            ...
                                            <input class="input100" type="text" value="<%= rs.getString(9)%>"
                                                name="Mobile" placeholder="Enter phone number" readonly>
                                            <span class="focus-input100"></span>
                                        </div>
